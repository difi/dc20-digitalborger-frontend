      ...
      {prescriptionData.Prescriptions.map((prescription, index) => (
        <View
          ...
          style={{
            ...
            borderBottomWidth:
              index == prescriptionData.Prescriptions.length - 1 ? 0 : 1,
          }}
        >
            ...
            <TouchableOpacity
              ...
              onPress={() =>
                WebBrowser.openBrowserAsync(
                  "https://helsenorge.no/om-min-helse/meldinger"
                )
              }
            >
              <Text style={styles.text} allowFontScaling={true}>
                {prescription1.status}
              </Text>
