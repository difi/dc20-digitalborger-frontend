  ...
  return (
    <View>
      ...
      <View style={styles.linksContainer}>
            <TouchableOpacity
                style={styles.links}
                onPress={() => Linking.openURL("https://www.skatteetaten.no/person/folkeregister")}
            >
      ...
      <View style={styles.linksContainer}>
          <TouchableOpacity
              style={styles.links}
              onPress={() => Linking.openURL("https://brukerprofil.difi.no/minprofil/?goto=https://sok.samordnaopptak.no/")}
          >
              <EntypoIcon name="export" size={20} />
